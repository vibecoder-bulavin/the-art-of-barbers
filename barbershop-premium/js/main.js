...
function initReviews() {
  const reviews = [
    {
      text: "Примерен отзив — тук ще стоят реални мнения за вашия барбершоп. Идеален fade, приятна атмосфера и професионално отношение.",
      author: "— Ваш клиент, постоянен посетител",
    },
    {
      text: "Втори примерен отзив. Заменете с текст от Google, Facebook или вашия сайт — какво ценят клиентите във вашия салон.",
      author: "— Ваш клиент, fade и брада",
    },
    {
      text: "Трети примерен отзив за VIP или пакетни услуги. Подчертайте качеството, чистотата и вниманието към детайла.",
      author: "— Ваш клиент, премиум услуга",
    },
  ];
...
function initBookingModal() {
  ...
  form?.addEventListener("submit", (e) => {
    ...
    alert(`Благодарим, ${name}! Това е демо форма — свържете я с вашия телефон или система за записване.`);
    form.reset();
    close();
  });
}
